...
#+BEGIN_SRC emacs-lisp
  (use-package ivy
    ...
    (set-face-attribute 'ivy-current-match nil :background "#2F4F4F" :foreground "SpringGreen1" :weight 'normal )
...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    :bind (
           ;; ("C-x r" . xref-find-references) somehow does not work
           ("C-x r" . lsp-find-references)
