...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sd/counsel-git-grep-minimum-height()
  ...
  (add-hook 'minibuffer-setup-hook #'sd/counsel-git-grep-minimum-height)
...
#+BEGIN_SRC emacs-lisp
  (defun sd/vterm-hook ()
      ...
      ;; colors
      (setq buffer-face-mode-face `(:background "gray18"))
      (set-face-attribute 'vterm-color-default nil :background "gray18" )
      (buffer-face-mode 1)
