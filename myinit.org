...
;;  (set-face-background 'fringe "#2F4F4F")
  ...
  (set-face-attribute 'region nil :background "gray31" :foreground "yellow" )
...
#+BEGIN_SRC emacs-lisp
    ...
    :config
      (set-face-attributee 'term nil :background "black" )
  ;; (set-face-attribute 'default nil :background "#2F4F4F")
  ;;        Foreground: #FFF8DC
