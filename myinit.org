...
*** Commented out code, keeping it so I know how to do this in the future
;; Keeping this code for now so I know how to do this in the future
...
;      (message "multiple cursors disabled")
;)
