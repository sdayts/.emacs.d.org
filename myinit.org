...
#+BEGIN_SRC emacs-lisp
  ...
  (defhydra sd/hydra-main (:color pink
                           :hint nil)
    "
  ^Places^                        ^Shortcuts^       ^Actions^
  ^^^^^^^^---------------------------------------------------------------------
  _a_: Agenda                     _m_: Magit        _k_: Kill current buffer
  _A_: Display Agenda             _v_: Vterm
  _I_: Init Configuration File    _d_: Dired
  _s_: Scratch Buffer             _i_: IBuffer

  "
    ("a" (find-file "/Users/sdayts/notes/agenda.org")        "agenda.org"     :color blue)
    ("A" org-agenda-list                                     "Display Agenda" :color blue)
    ("I" (find-file "/Users/sdayts/.emacs.d.org/myinit.org") "config"         :color blue)
